    ...
    <script>
        ...
        function changePrice(foodId, newPrice) {
            ...
            .then(data => {
                ...
                document.getElementById(`price-€{foodId}`).innerText = `€€{data.price}.00`;
            })
            .catch(error => {
...
<body>
    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate" id="food-1">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<div class="d-flex">
								...
								<a href="#" class="add-to-cart d-flex justify-content-center align-items-center text-center">
									...
									<a href="#" class="btn btn-danger mx-1" onclick="deleteFood(1)">Supprimer</a>
									<a href="#" class="btn btn-warning mx-1" onclick="changePrice(1, 70)">Modifier Prix</a>
								</div>
							</div>
						</div>
					</div>
